<x-filament-panels::page>
    ...
    {{-- Placeholder dla Faz 2-5 (timeline / invoices / messages / files).
         W każdej kolejnej fazie zastąpimy hint widgetem / linkiem do
         nowego tab'u. --}}
    <section class="space-y-3 rounded-lg border border-dashed border-gray-200 p-4 text-sm text-gray-500 dark:border-gray-800">
        ...
        <ul class="ml-4 list-disc space-y-1">
            <li>{{ __('owner/horse_detail.upcoming.timeline') }}</li>
            <li>{{ __('owner/horse_detail.upcoming.invoices') }}</li>
