...
<head>
    ...
    <title>{{ __('specialist/setup.invalid.title') }}</title>
    <style>
        ...
        h1 { color: #ef4444; margin: 0 0 .5rem; font-size: 1.5rem; }
        p { color: #4b5563; line-height: 1.5; }
    </style>
</head>
<body>
    <div class="container">
        <h1>{{ __('specialist/setup.invalid.heading') }}</h1>
        <p>{{ __('specialist/setup.invalid.body') }}</p>
    </div>
</body>
</html>
