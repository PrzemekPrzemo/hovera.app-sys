...
return [
    ...
    'notify' => [
        'lead_prefilled_title' => 'Данные запроса заполнены автоматически',
        'lead_prefilled_body' => 'Адреса и контакт клиента уже заполнены — нажмите «Рассчитать», чтобы получить цену.',
    ],
