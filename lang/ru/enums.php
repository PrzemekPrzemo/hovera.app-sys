...
return [
    ...
    'transporter_document_type' => [
        ...
        'animal_transport_cert_description' => 'Старый сертификат ЕС 1/2005 — заменён на Сертификат одобрения транспортного средства PWL.',
        'insurance_ocp' => 'Страхование ответственности перевозчика (legacy)',
        'insurance_ocp_description' => 'Заменено новой записью «Страхование ответственности перевозчика» в списке PWL.',
        ...
        'vehicle_registration_description' => 'Заменено Сертификатом одобрения транспортного средства PWL.',

        // PWL — польский режим внутрисоюзной перевозки живых животных.
        ...
        'pwl_authorization_type1' => 'Разрешение перевозчика PWL — Тип 1 (< 8 ч)',
        ...
        'pwl_authorization_type2' => 'Разрешение перевозчика PWL — Тип 2 (> 8 ч)',
        ...
        'pwl_driver_handler_certificate' => 'Лицензии для водителей и обслуживающих лиц (PWL)',
        ...
        'pwl_vehicle_approval_certificate' => 'Сертификат одобрения транспортного средства (PWL)',
