...
return [
    'form' => [
        ...
        'lookup' => [
            'action_label' => 'Загрузить из GUS/CEIDG/KRS',
            'invalid_nip' => 'Неверный NIP — проверьте контрольную сумму.',
            'not_found' => 'Компания не найдена. Проверьте NIP или введите данные вручную.',
            'success' => 'Данные загружены из публичных реестров.',
            'success_sources' => 'Источники: :sources',
        ],
    ],
