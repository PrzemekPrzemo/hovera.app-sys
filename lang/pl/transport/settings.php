...
return [
    ...
    'form' => [
        'label' => [
            ...
            'fuel_calculation_mode' => 'Tryb naliczania paliwa',
        ...
        'helper' => [
            ...
            'fuel_surcharge_enabled' => 'Doliczamy paliwo do wyceny (tryb określa metoda).',
            'fuel_calculation_mode' => '„Dopłata" — dolicza tylko różnicę nad cenę bazową (rate_per_km wlicza paliwo po bazie). „Pełen koszt" — dolicza pełen koszt aktualnej ceny × spalanie × dystans (rate_per_km tylko praca i marża).',
            'fuel_base_price_pln' => 'Cena bazowa ON używana w trybie „Dopłata" — surcharge naliczany od różnicy. W trybie „Pełen koszt" pole nieaktywne.',
