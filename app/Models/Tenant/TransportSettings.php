...
class TransportSettings extends Model
{
    ...
    protected $fillable = [
        ...
        'fixed_fees_default', 'surcharge_percent_default',
        'fuel_consumption_l_per_100km', 'fuel_surcharge_enabled', 'fuel_calculation_mode', 'fuel_base_price_pln',
    ...
    protected function casts(): array
    {
        return [
            ...
            'fixed_fees_default' => 'array',
            'surcharge_percent_default' => 'decimal:2',
    ...
    public static function defaults(): array
    {
        return [
            ...
            'fixed_fees_default' => [],
            'surcharge_percent_default' => null,
            'fuel_consumption_l_per_100km' => 32.5,
            'fuel_surcharge_enabled' => true,
            'fuel_calculation_mode' => 'surcharge',
